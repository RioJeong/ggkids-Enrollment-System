...
<div class="container">
   <table class="table table-success">
      <tr><td align="center" style="color: white; font-size: 18px;">교수 정보</td></tr>
   </table>
   <table class="table table-striped" frame=void border>
      <form name="infor_form" method="post" action="update.jsp">
         <tr>
            <td class="td-class"><div align="center">교번</div></td>
            <td align="center"><%=session_id%></td>
         </tr>
         <tr>
            <td class="td-class"><div align="center">이름</div></td>
            <td align="center"><%=r_name%></td>
         </tr>
         <tr>
            <td class="td-class"><div align="center">패스워드</div></td>
            <td><div align="center" name="userPassword">****</div></td>
         </tr>
         <tr>
            <td class="td-class"><div align="center">전화번호</div></td>
            <td><div align="center" name="userPhone"><%=r_phone%></div></td>
         </tr>
         <tr>
            <td class="td-class"><div align="center">이메일</div></td>
            <td><div align="center" name="uesrEmail"><%=r_email%></div></td>
         </tr>
         <tr>
            <td colspan=2>
               <div align="center">
                  <input class="btn btn-success" type="button" name="btn1"
                     value=" 수정  " onclick="javascript:location.href='p_update.jsp'" ;/>
                  <input class="btn btn-success" type="button" name="btn2"
                     value=" 확인  " onclick="javascript:location.href='p_main.jsp'" ; />
               </div>
            </td>
         </tr>
      </form>
