...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a href="main.jsp"><img src="./logo.png" width="240px" height="60px" style="margin-left:30px;"/></a>
  ...
  <div class="collapse navbar-collapse" id="navbarColor01" style="margin-left:180px;" >
    <ul class="navbar-nav mr-auto" style="font-size:20px; font-weight:400;">
      <li class="nav-item">
      <a class="nav-link" href="s_information.jsp">학생 정보</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="insert.jsp">수강 신청</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="select.jsp">수강 조회</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="delete.jsp">수강 삭제</a>
      </li>
      <li class = "nav-item">
         <a class="nav-link" href="message.jsp">메시지함</a>
      </li>
    </ul>
    <% if(session_id!=null){%>
...
if (myResultSet3 != null) { 
   ...
   if(myResultSet3.getInt("COUNT")>0){
      %>
     <a href="message.jsp"><img src="new_message_icon.png" style="position:fixed;right:50px;bottom:30px;" width=120px height=100px></a>
      <%    
   }
   else {
   %>
   <a href="message.jsp"><img src="message_icon.png" style="position:fixed;right:50px;bottom:30px;" width=100px height=100px></a>
   <%
    }
}
}
