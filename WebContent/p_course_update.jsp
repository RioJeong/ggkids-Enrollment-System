...
<body>
   ...
   <table class="table table-hover" align="center" style="width: 90%; margin-top: 80px;">
      <br>
      ...
      <%
         ...
         try {
            ...
            while (rs.next()) {
               ...
               int student_cnt=0;
                mySQL = "select count(*) from enroll where c_id='"+c_id+"'and c_id_no="+c_id_no+"and c_year="+c_year
                      +"and c_semester="+c_semester;
      ...
      <tr>
         ...
         <td align="center">
            <span class="badge badge-pill badge-success" style="height:30px;width:50px;padding:8px; ">
              ...
              href="p_course_update_exe.jsp?c_id=<%= c_id %>&c_id_no=<%= c_id_no %>&c_year=<%= c_year %>&c_semester=<%= c_semester %>">편집</a>
            </span>
            </td> 
      </tr>
